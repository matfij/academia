    ...
    private static allies: Character[] = [
        ...
        },
        {
            ...
            moves: [
                ...
                { id: 'move-3', name: 'Bolt of Bahamut', damage: 75 },
            ],
        },
        {
            id: 'player-3',
            ...
            moves: [
                { id: 'move-6', name: 'Regular Swing', damage: 10 },
                { id: 'move-7', name: 'Piercing Strike', damage: 30 },
                { id: 'move-8', name: 'Fervent Qilin Slash', damage: 90 },
                { id: 'move-9', name: 'Black Dragon', damage: 200 },
            ],
        },
    ];
